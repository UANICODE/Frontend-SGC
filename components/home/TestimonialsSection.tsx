...
export function TestimonialsSection() {
  return (
    <section
      id="testemunhos"
      className="border-b border-borderLight/30 bg-gradient-to-b from-white via-backgroundLight to-white py-20 md:py-28 relative overflow-hidden scroll-mt-20"
    >
        ...
        >
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#FF7A1A]/10 to-[#FF9E3A]/10 border border-[#FF7A1A]/20 mb-4">
              ...
              <span className="text-xs font-bold text-[#FF7A1A] uppercase tracking-wide">
                Testemunhos
              </span>
            </div>
            <h2 className="text-4xl font-bold text-textPrimaryLight md:text-5xl mb-4 leading-tight">
              Veja quem ja contou com a{" "}
              <span className="text-[#FF9E3A]">Foodnect</span> para decidir
              onde comer.
            </h2>
          ...
          {TESTIMONIALS.map((t, idx) => (
            <motion.article
              ...
              style={{
                ...
                boxShadow: "0 0 0 1px #FF7A1A inset",
              }}
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-5">
                  ...
                  >
                    <Image
                      src={t.image || "/fallback-avatar.png"} // fallback automático
                      alt={t.name}
                      fill
                      priority={true} // carregamento obrigatório
                      sizes="64px"
                      className="object-cover"
                      placeholder="blur"
                      blurDataURL="/fallback-avatar.png"
                      onError={(e) => {
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-textSecondaryLight mb-1">
                      {t.role}
                    </p>
