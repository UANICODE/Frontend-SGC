// components/admin/modals/EditCostCategoryModal.tsx
"use client";

import { useState, useEffect } from "react";
import { X, Save, Tag, FileText } from "lucide-react";
import { useUpdateCostCategory } from "@/hooks/admin/cost/useUpdateCostCategory";
...
export function EditCostCategoryModal({ category, establishmentId, onClose, onSuccess }: Props) {
    const { showToast } = useToast();
    const { execute, loading } = useUpdateCostCategory();
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-white/80 text-sm">Altere os dados da categoria</p>
                            </div>
                        </div>
                        <button
                            onClick={onClose}
