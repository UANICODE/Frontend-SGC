// components/admin/modals/CreateCostCategoryModal.tsx
"use client";

import { useState } from "react";
import { X, Save, Tag, FileText } from "lucide-react";
import { useCreateCostCategory } from "@/hooks/admin/cost/useCreateCostCategory";
...
export function CreateCostCategoryModal({ establishmentId, onClose, onSuccess }: Props) {
    const { showToast } = useToast();
    const { execute, loading } = useCreateCostCategory();
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-white/80 text-sm">Crie uma nova categoria de custo</p>
                            </div>
                        </div>
                        <button
                            onClick={onClose}
