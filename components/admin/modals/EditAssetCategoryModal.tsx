// components/admin/asset/EditAssetCategoryModal.tsx
"use client";
...
export function EditAssetCategoryModal({ category, establishmentId, onClose, onSuccess }: Props) {
    const { showToast } = useToast();
    const { execute, loading } = useUpdateAssetCategory();
            ...
            <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="p-6 space-y-4">
                    <div>
                        ...
                        <input
                            type="text"
                            placeholder="Ex: Equipamentos, Mobiliário..."
                            value={form.name}
