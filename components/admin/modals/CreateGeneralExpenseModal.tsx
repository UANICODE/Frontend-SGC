// components/admin/modals/CreateGeneralExpenseModal.tsx
"use client";

import { useState } from "react";
import { X, Save, DollarSign, Tag, FileText, Calendar, Clock } from "lucide-react";
import { useCreateGeneralExpense } from "@/hooks/admin/cost/useCreateGeneralExpense";
...
export function CreateGeneralExpenseModal({ establishmentId, onClose, onSuccess }: Props) {
    const { showToast } = useToast();
    const { execute, loading } = useCreateGeneralExpense();
            ...
            <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="p-6 space-y-4 max-h-[60vh] overflow-y-auto">
                    ...
                    <div>
                        ...
                        {loadingCategories && (
                            <p className="text-xs text-gray-400 mt-1">Carregando categorias...</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            placeholder="Ex: Aluguel Fevereiro 2026, Salários..."
