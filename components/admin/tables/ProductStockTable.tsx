// components/admin/tables/ProductStockTable.tsx
"use client";

import { ProductStockItemResponse } from "@/types/admin/product-stock";
import { Trash2, ArrowRight, Package, TrendingUp, AlertCircle, ShoppingCart } from "lucide-react";
...
interface Props {
    ...
    onAddToCart: (item: ProductStockItemResponse) => void;
}
                                ...
                                >
                                    ...
                                    <td className="p-4 text-center">
                                        <div className="flex justify-center gap-2 flex-wrap">
                                            ...
                                            >
                                                <div className="absolute inset-0 bg-gradient-to-r from-primary/80 to-secondary/80 opacity-0 group-hover/btn:opacity-100 transition-opacity"></div>
                                                <ShoppingCart className="w-3.5 h-3.5 relative z-10" />
                                                <span className="relative z-10">Adicionar</span>
                                            </button>

                                            {/* 🔥 BOTÃO REMOVER (antigo Entrada foi removido) */}
                                            <button
